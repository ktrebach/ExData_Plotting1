...
with(powerdata2, {
      ...
      plot(x=powerdata2$fulldate, y=powerdata2$Voltage, xlab="datetime", ylab="Voltage", type="l")
      plot(x=powerdata2$fulldate, y=powerdata2$Global_reactive_power, type="l", xlab="datetime",ylab="Global_reactive_power")
